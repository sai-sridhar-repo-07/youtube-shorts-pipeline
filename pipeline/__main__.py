...
_FALLBACK_TOPICS = [
    ...
    "The manipulation technique used by every cult that actually works on anyone",
    "Why gaslighting is so effective and how your brain falls for it every time",
    "The dark reason why nice people attract toxic partners repeatedly",
    "How narcissists pick their victims and the exact traits they look for",
    "The psychological trick abusers use to make victims feel guilty for leaving",
    "Why your brain confuses trauma bonding with real love",
    "The dark side of empathy that nobody talks about",
    "How con artists exploit your brain's trust system in seconds",
    "The psychological reason why smart people stay in bad relationships",
    "Why revenge never makes you feel better according to neuroscience",
    "The manipulation tactic used by salespeople that is almost impossible to resist",
    "How authoritarian regimes brainwash entire populations step by step",
    "The dark psychology of why people enjoy watching others fail",
    "Why your brain is hardwired to obey authority even when it is wrong",
    "The psychological trick behind every viral scam and why it always works",
    "How propaganda rewires the brain after just three exposures",
    "The terrifying reason why eyewitness testimony is almost always wrong",
    "Why humans are psychologically designed to follow crowds even off a cliff",
    "The dark truth about why people stay silent when witnessing injustice",
    "How social media was specifically engineered to make you addicted",
    # ── Shocking Science Facts ─────────────────────────────────────────────────
    "The terrifying discovery that your decisions are made 7 seconds before you know it",
    "Why scientists think consciousness might be an illusion your brain creates",
    "The shocking truth about how little of your DNA actually does anything",
    "How your memories are being rewritten every single time you recall them",
    "The disturbing fact that your body replaces itself completely every 7 years",
    "Why scientists discovered that trees can scream when they are thirsty",
    "The mind-bending proof that reality might not exist when nobody is looking",
    "How quantum mechanics proves particles can be in two places at once",
    "The shocking discovery that plants communicate danger to each other instantly",
    "Why your immune system kills cancer cells thousands of times every day",
    "The terrifying fact that most of your body mass is actually not human cells",
    "How scientists proved that time moves slower near heavy objects",
    "The mind-blowing discovery that the sun makes a sound nobody can hear",
    "Why your body produces enough electricity to power a small light bulb",
    "The shocking fact that every atom in your body was forged in a dying star",
    "How bees can solve math problems that stump most children",
    "The disturbing discovery that viruses are the most abundant life form on earth",
    "Why octopuses have three hearts and blue blood and what that means",
    "The fact that glass is actually a very slow-moving liquid not a solid",
    "How crows remember human faces and hold grudges for years",
    "The shocking discovery that dolphins call each other by name",
    "Why sharks are older than trees and survived five mass extinctions",
    "The terrifying fact that the Pacific garbage patch is now twice the size of Texas",
    "How the human eye can distinguish between 10 million different colors",
    "The shocking truth that lightning strikes the earth 100 times every second",
    # ── Money Secrets & Wealth ────────────────────────────────────────────────
    "The secret investment strategy Warren Buffett never talks about publicly",
    "Why the middle class is being systematically eliminated and who benefits",
    "The hidden tax loophole billionaires use that most people never know exists",
    "How credit card companies deliberately engineer debt you cannot escape",
    "The dark reason why financial literacy is not taught in schools",
    "Why the housing market is designed to keep renters renting forever",
    "The investment that has beaten the stock market for the last 100 years",
    "How banks profit billions from rounding errors you never notice",
    "The wealth-building secret that has worked for 3000 years straight",
    "Why your 401k is secretly making your employer richer than you",
    "The dark truth about how insurance companies calculate your death",
    "How the ultra wealthy legally earn millions while paying zero income tax",
    "The hidden fees in your mutual fund that cost you hundreds of thousands",
    "Why dollar cost averaging beats every expert investment strategy",
    "The shocking amount of money you lose by buying a new car instead of used",
    "How to negotiate any price down by 30 percent using one simple phrase",
    "The financial trap hidden inside every buy now pay later offer",
    "Why renting is sometimes smarter than buying and the math proves it",
    "The debt avalanche method that can save you decades of payments",
    "How starting a business changes your taxes in ways employees never get",
    # ── Hidden History & Dark Secrets ────────────────────────────────────────
    "The ancient civilization that was more advanced than Rome and was erased from history",
    "The dark truth about what really ended the Library of Alexandria",
    "How the CIA secretly ran the entire world LSD supply in the 1950s",
    "The hidden history of how corporations owned entire countries",
    "Why the Black Death was secretly the best thing that happened to workers",
    "The ancient Roman vending machine that worked exactly like modern ones",
    "How Napoleon was not actually short and who invented that lie and why",
    "The medieval pandemic that killed more people than World War Two",
    "The dark secret behind why the pyramids were built that archaeologists debate",
    "How the Great Wall of China was built with rice soup mortar",
    "The forgotten empire that ruled half the world before anyone remembers",
    "Why the Soviet Union secretly put a man in space before Yuri Gagarin",
    "The dark truth about how chocolate was kept secret from Europe for 100 years",
    "How America was secretly bankrupt after World War Two and what really saved it",
    "The ancient battle that was so brutal it changed warfare forever",
    "Why one assassination started a war that killed 20 million people",
    "The hidden history of how women were erased from science textbooks",
    "The dark story of the country that tried to eliminate an entire language",
    "How one man accidentally discovered penicillin and saved 200 million lives",
    "The secret wartime project that almost blew up the entire state of New Mexico",
    "Why ancient Greeks believed the earth was round 2000 years before Columbus",
    "The forgotten female mathematicians who made the moon landing possible",
    "How the Mongol Empire spread knowledge across the entire known world",
    "The dark reason why Rome fell that historians still argue about today",
    # ── AI & Future Technology ────────────────────────────────────────────────
    "Why AI will eliminate 40 percent of all jobs within the next 10 years",
    "The terrifying thing that happened when two AI systems were left to talk",
    "How AI can now detect cancer better than any human doctor",
    "The dark truth about who actually controls the world's most powerful AI",
    "Why Elon Musk is secretly terrified of artificial intelligence",
    "How deepfake technology is now indistinguishable from real video",
    "The AI that taught itself to walk with no human programming at all",
    "Why quantum computers will break every encryption system in the world",
    "How brain-computer interfaces will change what it means to be human",
    "The terrifying way AI can now predict your behavior before you decide",
    "Why robots can now perform surgery better than the best human surgeons",
    "How artificial intelligence discovered a new antibiotic nobody knew existed",
    "The chilling moment an AI became self-aware during a research experiment",
    "Why the metaverse might replace reality sooner than anyone expects",
    "How AI is already writing your news articles without you knowing",
    "The terrifying accuracy of facial recognition on every street you walk",
    "Why your smartphone already knows you better than your therapist does",
    "How gene editing will soon let parents design their children",
    "The dark side of autonomous weapons that nobody wants to talk about",
    "Why some scientists believe we will achieve immortality before 2050",
    # ── Human Behavior & Social Secrets ──────────────────────────────────────
    "Why attractive people are treated differently from birth to death",
    "The dark psychology of why we care what strangers think of us",
    "How birth order permanently shapes your personality without you knowing",
    "Why humans are the only animals that cry from emotion",
    "The hidden reason why people with accents are trusted less",
    "How your name secretly determines your career success",
    "Why taller people earn significantly more money on average",
    "The dark truth about how loneliness physically kills you faster than smoking",
    "How people in happy marriages literally live 10 years longer",
    "Why people who talk to themselves are smarter on average",
    "The shocking science of why we find certain faces beautiful",
    "How your handshake communicates your health status to others",
    "Why humans universally prefer the same facial features across all cultures",
    "The dark psychology behind why we enjoy watching reality television",
    "How wearing certain colors changes how people respond to you",
    "Why people with difficult childhoods often become the most successful adults",
    "The hidden reason why most people never achieve their biggest goals",
    "How social rejection activates the exact same brain region as physical pain",
    "Why people tip more when the server touches their arm briefly",
    "The surprising truth about whether online friendships are real",
    # ── Space & Cosmic Horror ─────────────────────────────────────────────────
    "The terrifying thing that would happen to your body if you fell into a black hole",
    "Why space is completely silent and what that means for anyone stranded there",
    "The dark zone of the universe where physics completely breaks down",
    "How the nearest star is so far that a spaceship would take 70000 years",
    "The terrifying possibility that we are the only intelligent life in the universe",
    "Why some scientists believe the universe is conscious",
    "The dark energy that makes up 68 percent of everything and nobody knows what it is",
    "How a magnetar 50000 light years away could erase all life on earth",
    "The terrifying Fermi paradox and why the silence of space should scare you",
    "Why every star you can see at night is already billions of years old",
    "The cosmic event that will inevitably destroy the Milky Way in 4 billion years",
    "How the universe will eventually die in perfect darkness and cold silence",
    "Why the moon is slowly drifting away and what happens when it is gone",
    "The terrifying gamma ray burst that could sterilize an entire galaxy",
    "How scientists found planets made entirely of burning ice",
    # ── Weird Laws of Nature ──────────────────────────────────────────────────
    "The physical law that says the future can influence the past",
    "Why you can never actually touch anything because atoms never make contact",
    "The mathematical proof that you are probably living in a simulation",
    "How entropy means the universe is constantly becoming more chaotic",
    "Why the Mandela effect might actually be proof of parallel universes",
    "The observer effect that proves watching something changes what happens",
    "How Schrödinger's cat proves reality is fundamentally probabilistic",
    "Why light behaves as both a particle and a wave depending on who looks",
    "The strange loop paradox that breaks every logical system ever created",
    "How infinite sets can be larger than other infinite sets mathematically",
    "Why there is no north pole of the sun despite what every map shows",
    "The paradox of the ship of Theseus that philosophers still cannot solve",
    "How every color you see is actually your brain's interpretation not reality",
    "Why zero was the most dangerous mathematical idea ever discovered",
    "The strange attractor that shows how chaos has hidden order",
    # ── Survival & Extreme Situations ────────────────────────────────────────
    "The survival instinct that turns ordinary people into superhumans in emergencies",
    "Why people lost at sea hallucinate before they die and what they see",
    "The one rule Navy SEALs use to survive any impossible situation",
    "How to survive a fall from a plane with no parachute according to science",
    "The dark psychology of why groups of survivors turn on each other",
    "How the human body can survive 3 weeks without food but only 3 days without water",
    "The mountain climbers who survived by doing something counterintuitive",
    "Why people survive lightning strikes and what happens to the brain after",
    "How hypothermia kills people before they even realize they are in danger",
    "The unlikely things that have saved people from shark attacks",
    # ── Bizarre Medical Facts ─────────────────────────────────────────────────
    "The disease that makes people allergic to exercise",
    "Why some people are born without the ability to feel any physical pain",
    "The rare condition where people cannot recognize faces including their own",
    "How a parasite that lives in cats might be controlling human behavior",
    "The medical mystery of why some people age in reverse",
    "Why doctors can tell your exact age from a single drop of blood",
    "The bizarre condition where patients wake up speaking foreign languages",
    "How one blood type can receive blood from any human on earth",
    "The terrifying parasite that replaces a fish's tongue with itself",
    "Why some people can hear their own eyeballs moving",
    "The medical fact that your appendix is actually part of your immune system",
    "How chronic stress literally shrinks your brain over time",
    "The rare superpower where some people never need more than 4 hours of sleep",
    "Why certain people can smell diseases before any symptoms appear",
    "The human body part that continues growing after death",
    # ── Corporate & Government Secrets ───────────────────────────────────────
    "The dark reason why pharmaceutical companies suppress natural cures",
    "How big tobacco companies knew cigarettes caused cancer for 30 years",
    "The secret government program that experimented on citizens without consent",
    "Why fast food companies deliberately engineer food to override your fullness",
    "The dark truth about how social media companies profit from your depression",
    "How oil companies buried their own climate research decades ago",
    "The secret ingredient in processed food that makes it chemically addictive",
    "Why governments fluoridated water and the real reason behind the decision",
    "The dark history of how companies used child labor globally until yesterday",
    "How every search result you see is personalized to manipulate your opinion",
    # ── Neuroscience & Brain Facts ─────────────────────────────────────────────
    "The terrifying fact that your brain is constantly hallucinating reality",
    "Why your brain physically cannot multitask no matter how smart you are",
    "The shocking discovery that gut bacteria send signals directly to your brain",
    "How your brain rewrites your memories to make you look better",
    "Why the brain of a 25-year-old is literally not fully developed yet",
    "The dark reason why breakups feel physically identical to losing a limb",
    "How music activates more of the brain than any other human activity",
    "The terrifying way sleep deprivation mimics the effects of schizophrenia",
    "Why your brain gives you a dopamine hit just from planning something fun",
    "The shocking discovery that creative people have slightly different brains",
    "How the brain of a London taxi driver physically grows from memorizing routes",
    "Why learned helplessness turns capable people into victims permanently",
    "The neuroscience of why you forget your dreams within 10 minutes of waking",
    "How blind people dream in the same way sighted people do",
    "The brain region that activates when you listen to music that gives you chills",
    # ── Ancient Mysteries & Lost Knowledge ───────────────────────────────────
    "The ancient technology that should not have existed but clearly did",
    "How the Baghdad battery proves ancient civilizations had electrical knowledge",
    "The lost city that may have been swallowed by the sea overnight",
    "Why the Antikythera mechanism is 1500 years ahead of its time",
    "The ancient map that accurately shows Antarctica before anyone discovered it",
    "How Stonehenge was built with technology nobody can fully explain today",
    "The Nazca lines that can only be seen from the air and why they exist",
    "Why ancient texts from different civilizations describe identical flood myths",
    "The lost Roman concrete formula that has outlasted every modern material",
    "How ancient Egyptians transported 2.5 ton blocks with no modern equipment",
]
